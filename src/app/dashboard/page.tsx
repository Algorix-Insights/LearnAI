        ...
        <AppShell activeHref="/dashboard">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="dashboard-grid">
                    ...
                    >
                        <div className="flex flex-col gap-1">
                            <div className="flex justify-between items-center">
                                ...
                                <Trophy className="w-6 h-6 shrink-0 text-[color:var(--app-primary)]"
                                    strokeWidth={2} />
                            </div>
                            <p className="text-4xl font-semibold text-[color:var(--app-primary)]">65%</p>
                    ...
                    {/* Cuadernos dominados */}
                    <MasteredNotebooksCard data={{ mastered: 2, total: 4 }} />
