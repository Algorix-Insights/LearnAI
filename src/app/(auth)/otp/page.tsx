...
import { clearPendingOtpSession, getPendingOtpEmail, storeAuthToken } from "@/lib/auth-client"
...
export default function InputOTPInvalid() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full p-6">
            <div className="flex flex-col items-center justify-center min-h-[250px] max-w-lg bg-zinc-950 p-6 rounded-2xl border border-zinc-800 shadow-2xl">
                ...
                <Button
                    ...
                    disabled={isVerifyingOtp || !email || value.length !== 6}
