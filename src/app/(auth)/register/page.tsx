        ...
        <section className="grid w-full min-h-screen overflow-hidden shadow-[0_24px_80px_rgba(88,75,255,0.22)] ring-1 ring-white/70 backdrop-blur-xl lg:grid-cols-[1.08fr_0.92fr]">
            ...
            <div className="flex items-center justify-center px-5 py-8 sm:px-8 lg:px-10">
                <div className="w-full max-w-lg">
                    <h2 className="mt-1 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">Registrarse</h2>
                    ...
                    <p className="mt-7 text-center text-sm text-slate-500">
                        Ya tienes una cuenta? <Link href="/login" className="font-semibold text-indigo-500 transition hover:text-indigo-600">Inicia Sesión</Link>
                    </p>
                </div>
            </div>
        </section>
