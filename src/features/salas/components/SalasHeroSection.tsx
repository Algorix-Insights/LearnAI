...
type SalasHeroSectionProps = {
  search: string;
  onSearchChange: (value: string) => void;
};

export function SalasHeroSection({ search, onSearchChange }: SalasHeroSectionProps) {
  return (
    <section>
        ...
        <div className="flex w-full flex-col items-start gap-8">
          <div>
            <h1 className="mt-14 bg-gradient-to-r from-[#28D8C5] to-[#7452F5] bg-clip-text text-4xl text-transparent">
              Estamos en las Salas de Estudio
            </h1>
            <p className="mt-4 text-md text-gray-500">Aprende en equipo</p>
          </div>
